...
export const vehicleTypes = pgTable("vehicle_types", {
  ...
  cityLabel: text("city_label").default("시내투어"),
  onewayPrice: integer("oneway_price").notNull().default(0),
  onewayLabel: text("oneway_label").default("편도(붕따우)"),
  hochamOnewayPrice: integer("hocham_oneway_price").notNull().default(0),
  hochamOnewayLabel: text("hocham_oneway_label").default("편도(호짬)"),
  phanthietOnewayPrice: integer("phanthiet_oneway_price").notNull().default(0),
  phanthietOnewayLabel: text("phanthiet_oneway_label").default("편도(판티엣)"),
  roundtripPrice: integer("roundtrip_price").notNull().default(0),
  roundtripLabel: text("roundtrip_label").default("왕복"),
  cityPickupDropPrice: integer("city_pickup_drop_price").notNull().default(0),
  cityPickupDropLabel: text("city_pickup_drop_label").default("픽드랍+시내"),
  sortOrder: integer("sort_order").default(0),
  isActive: boolean("is_active").default(true),
  createdAt: timestamp("created_at").defaultNow(),
});
